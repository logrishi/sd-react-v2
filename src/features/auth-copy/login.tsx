...
//       // Step 1: Check if user exists and is not deleted
...
//       // Step 5: Login with appropriate hash and get full user details
//       const loginResponse = await login({ email, password: loginHash }, { fields: USER_DETAILS_FIELDS });

//       // Store original password for session refresh
//       const result = await handleLoginSuccess(loginResponse, undefined, password);
//       if (!result.success) {
