...
// import { resetPassword, checkUserExists, login, handleLoginSuccess, USER_DETAILS_FIELDS } from "@/services/backend/actions";
...
//           if (result.success) {
//             // Update store to reflect password change
//             const currentState = store.auth.get();
//             store.auth.set({
//               ...currentState,
//               updatePassword: true
//             });
...
//     try {
//       // Hash password and reset with proper flags
...
//       } else {
//         // Store hashed password for auto-login through RootLayout
